...
- `templates/`: starter templates for new entries
- `materials/frameworks/`: baseline engineering frameworks used across skills and prompts
...
1. Add a skill in `skills/`.
2. Add prompt patterns in `prompts/`.
3. Store supporting references in `materials/`.
4. Use framework docs in `materials/frameworks/` as default coding guidance.
